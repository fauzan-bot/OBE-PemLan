...
<body style="background: url('images/background_skpi.png');background-image-resolution: from-image;">
        ...
        <table class="table">
            ...
            <tr>
                <td>
                    ...
                    <i style="font-size:13px;color:dark-grey">Faculty of <?= ucfirst($data['setupAplikasi']->fakultas_en) ?></i>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div style="text-align: center;">
        <h4 style="height: 50px;">
            ...
            <i style="font-size:16px;color:dark-grey">Diploma Supplement</i>
        </h4>
        ...
        <i style="font-size:13px;color:dark-grey">
            ...
            <tr>
                <td colspan="5">
                    <p style="font-size:13px">
                        ...
                        <i style="font-size:13px;color:dark-grey">/ Identity of Diploma Supplement Holders</i>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <p style="font-size:13px;">
                        NAMA LENGKAP
                        <i style="font-size:13px;color:dark-grey">/ Full Name</i>
                    </p>
                </td>
                <td colspan="2" style="width: <?= $_col_width ?>%;">
                    <p style="font-size:13px">
                        &nbsp;&nbsp;TANGGAL MASUK
                        <i style="font-size:13px;color:dark-grey">/ Date of Entry</i>
                    </p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <p style="font-size:13px">
                        ...
                        <i style="font-size:13px;color:dark-grey">/ Registration Number</i>
                    </p>
                </td>
                <td colspan="2" style="width: <?= $_col_width ?>%;">
                    <p style="font-size:13px">
                        &nbsp;&nbsp;TANGGAL LULUS
                        <i style="font-size:13px;color:dark-grey">/ Date of Completion</i>
                    </p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <p style="font-size:13px">
                        ...
                        <i style="font-size:13px;color:dark-grey"> / Place, Date of Birth</i>
                    </p>
                </td>
                <td colspan="2" style="width: <?= $_col_width ?>%;">
                    <p style="font-size:13px">
                        &nbsp;&nbsp;GELAR
                        <i style="font-size:13px;color:dark-grey">/ Tittle</i>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td style="vertical-align:top">
                    <p style="font-size:<?= $_isi_font ?>px;"> &nbsp;&nbsp;Sarjana Teknik (S. T.) <i style="font-size:<?= $_isi_font ?>px;color:dark-grey">/ Bachelor of Engineering</i></p>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="5">
                    <p style="font-size:13px">
                        ...
                        <i style="font-size:13px;color:dark-grey">/ Identity of Awarding Institutions</i>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <p style="font-size:13px">
                        PERGURUAN TINGGI
                        <i style="font-size:13px;color:dark-grey">/ Awarding Institutions</i>
                    </p>
                </td>
                <td colspan="2" style="width: <?= $_col_width ?>%;">
                    <p style="font-size:13px">
                        &nbsp;&nbsp;TOTAL SKS
                        <i style="font-size:13px;color:dark-grey">/ Total of Credit Semester Unit</i>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <p style="font-size:<?= $_isi_font ?>px;">
                        ...
                        <i style="font-size:<?= $_isi_font ?>px;color:dark-grey">/<?= $data['setupAplikasi']->univ_en ?></i>
                    </p>
                </td>
                <td style="width: <?= $isi ?>%;"></td>
                <td>
                    <p style="font-size:<?= $_isi_font ?>px;">
                        ...
                        <i style="font-size:<?= $_isi_font ?>px;color:dark-grey">/<?= $data['setupPrint']['total_sks'] ?> credits</i>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <p style="font-size:13px">
                        PROGRAM STUDI
                        <i style="font-size:13px;color:dark-grey">/ Department</i>
                    </p>
                </td>
                <td colspan="2" style="width: <?= $_col_width ?>%;">
                    <p style="font-size:13px">
                        &nbsp;&nbsp;DURASI STUDI REGULER
                        <i style="font-size:13px;color:dark-grey">/ Regular Duration of Study</i>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <p style="font-size:<?= $_isi_font ?>px;">
                        ...
                        <i style="font-size:<?= $_isi_font ?>px;color:dark-grey">/<?= $data['setupAplikasi']->prodi_en ?></i>
                    </p>
                </td>
                <td style="width: <?= $isi ?>%;"></td>
                <td>
                    <p style="font-size:<?= $_isi_font ?>px;">
                        ...
                        <i style="font-size:<?= $_isi_font ?>px;color:dark-grey">/<?= $data['semester'] ?> Semester <?= $data['total_bulan'] ?> Month</i>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <p style="font-size:13px">
                        FAKULTAS
                        <i style="font-size:13px;color:dark-grey"> / Faculty</i>
                    </p>
                </td>
                <td colspan="2" style="width: <?= $_col_width ?>%;">
                    <p style="font-size:13px">
                        &nbsp;&nbsp;SISTEM PENILAIAN
                        <i style="font-size:13px;color:dark-grey">/ Grading System</i>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td style="vertical-align: top;">
                    <p style="font-size:<?= $_isi_font ?>px;">
                        ...
                        <i style="font-size:<?= $_isi_font ?>px;color:dark-grey">/<?= $data['setupAplikasi']->fakultas_en ?></i>
                    </p>
                </td>
                <td style="width: <?= $isi ?>%;"></td>
                <td style="vertical-align: top;">
            ...
            <tr>
                ...
                <td colspan="2">
                    <p style="font-size:13px">
                        ...
                        <i style="font-size:13px;color:dark-grey"> Type and Level of Educations</i>
                    </p>
                </td>
                <td colspan="2" style="width: <?= $_col_width ?>%;">
                    <p style="font-size:13px">
                        &nbsp;&nbsp;PERSYARATAN PENERIMAAN <br>
                        <i style="font-size:13px;color:dark-grey">&nbsp;&nbsp;Entry Requirements</i>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td style="vertical-align: top;">
                    <p style="font-size:<?= $_isi_font ?>px;">
                        ...
                        <i style="font-size:<?= $_isi_font ?>px;color:dark-grey">Academic & Bachelor Degree</i>
                    </p>
                </td>
                <td style="width: <?= $isi ?>%;"></td>
                <td style="vertical-align: top;">
                    <p style="font-size:<?= $_isi_font ?>px;">
                        ...
                        <i style="font-size:<?= $_isi_font ?>px;color:dark-grey">&nbsp;&nbsp;Graduate from High School or Similar Education Level</i>
                    </p>
                </td>
            </tr>
        </table>
    ...
    <div style="position: fixed;">
        ...
        <div style="float: right; width: 23%;">
            <p style="text-align: right;font-size:12px;color:white">
