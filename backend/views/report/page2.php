...
<body style="background: url('images/background_skpi2.png');background-image-resize: 5;">
    <table class="table">
        ...
        <tr>
            ...
            <td colspan="2">
                <p style="font-size:12px">
                    ...
                    <i style="font-size:11px;color:dark-grey">3. INFORMATION OF QUALIFICATION AND ACHIEVEMENT</i>
                </p>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                <p style="font-size:12px">
                    ...
                    <i style="font-size:11px;color:dark-grey">3.1 LEARNING OUTCOMES</i>
                </p>
            </td>
        </tr>
        ...
        ?>
            <tr>
                <td style="width: 10%;"></td>
                <td style="width: 5%;border: 1px solid black;text-align:center;vertical-align:top;">
                ...
                <td style="text-align: justify;vertical-align: top;border: 1px solid black;">
                    <p style="font-size:12px;">
                        <?= $cpl->isi ?>
                        <br>
                        <i style="font-size:10,5px;color:dark-grey"><?= $cpl->isi_en ?></i>
                    </p>
                </td>
            </tr>
        <?php
        ...
        <tr>
            ...
            <td colspan="2">
                <p style="font-size:13px">
                    ...
                    <i style="font-size:13px;color:dark-grey">3.2 GRADUATE ACHIEVEMENT RESULT</i>
                </p>
            </td>
            <td style="width: <?= $head_width ?>%;"></td>
        </tr>
    ...
    <table>
        <tr>
            <td style="width: 76%;" rowspan="10">
                <img src="images/radar.png" style="align:left" width="150%">
            </td>
            <td rowspan="2" style="text-align:center;border: 1px solid black;">
                <p style="font-size: <?= $font_nilai ?>px;">
                    ...
                    <i style="font-size:<?= $font_nilai ?>px;color:dark-grey">Grade Range <br> (Scale 100)</i>
                </p>
            </td>
            <td colspan="2" style="text-align:center;border: 1px solid black;">
                <p style="font-size: <?= $font_nilai ?>px;">
                    <b> Rentang Nilai </b> <br>
                    <i style="font-size:<?= $font_nilai ?>px;color:dark-grey">Grading Range</i>
                </p>
            </td>
        </tr>
        <tr>
            <td style="text-align:center;border: 1px solid black;">
                <p style="font-size: <?= $font_nilai ?>px;">
                    <b> Angka </b> <br>
                    <i style="font-size:<?= $font_nilai ?>px;color:dark-grey">Number</i>
                </p>
            </td>
            <td style="text-align:center;border: 1px solid black;">
                <p style="font-size: <?= $font_nilai ?>px;">
                    <b> Huruf </b> <br>
                    <i style="font-size:<?= $font_nilai ?>px;color:dark-grey">Leter</i>
                </p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <?php  
                ...
                <p style="font-size: <?= $font_nilai ?>px;">
                    ...
                    <i style="font-size:<?= $font_nilai ?>px;color:dark-grey">Surakarta, <?= date("F d, Y", strtotime(ucfirst($data['setupPrint']['tgl_lulus']))) ?></i> <br><br>
                    DEKAN FAKULTAS TEKNIK <br>
                    <i style="font-size:<?= $font_nilai ?>px;color:dark-grey">Dean of Engineering Faculty</i> <br><br><br><br><br>

                    <u><?= $data['setupAplikasi']->nama_dekan ?></u> <br>
                    NIP. <?= $data['setupAplikasi']->nip_dekan ?> <br>
                    <i style="font-size:<?= $font_nilai ?>px;color:dark-grey">Employee ID Number</i>
                </p>
            </td>
        </tr>
    </table>
