            ...
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs"><?php echo (Yii::$app->user->identity->username) ?> (<?php echo (Yii::$app->user->identity->occupationki->occupation) ?>/<?php echo (Yii::$app->user->identity->prodigy->prodi) ?>)</span>
                    </a>
