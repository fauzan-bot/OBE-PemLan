    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                ...
                <a href="#"><i class="fa fa-circle text-success"></i> <?php echo ucfirst(Yii::$app->user->identity->occupationki->occupation) ?></a>
            </div>
        </div>
                ...
                'items' => [
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            ['label' => 'Monitoring Pembelajaran', 'icon' => 'circle', 'url' => ['/ref-mata-kuliah/monitoring'],],
                            [
                                'label' => 'Monev CPL',
                                'icon' => 'circle',
                                'url' => ['#'],
                    ...
                    ['label' => 'Setup User', 'icon' => 'users', 'url' => ['/user'], 'visible' => Yii::$app->user->identity->occupationki->occupation == "administrator"],
                    ['label' => 'Tentang', 'icon' => 'info-circle', 'url' => ['#']],
                    ['label' => 'Hak Akses', 'icon' => 'user-secret', 'url' => ['/user/akses']],
                ],
            ]
        ) ?>
