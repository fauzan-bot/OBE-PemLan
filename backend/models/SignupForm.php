...
class SignupForm extends Model
{
    ...
    {
        return [
            [['username', 'nama', 'nip', 'email', 'password', 'prodi'], 'required', 'message' => '{attribute} tidak boleh kosong'],
    ...
    public function signup()
    {
        ...
        $access = new UserOccupationProdi();
        $access->user_id = $user->id;
        $access->prodi_id = $user->prodi;
        $access->occupation_id = 2;
        $access->save();
