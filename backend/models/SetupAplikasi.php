...
class SetupAplikasi extends \yii\db\ActiveRecord
{
    ...
    public static function getDb() {
        if (Yii::$app->user->identity->prodigy->prodi == 'kimia') {
            return Yii::$app->kimia;
        }
        else if(Yii::$app->user->identity->prodigy->prodi == 'sipil') {
            return Yii::$app->sipil;
        }
        else if(Yii::$app->user->identity->prodigy->prodi == 'elektro') {
            return Yii::$app->elektro;
        }
        else if(Yii::$app->user->identity->prodigy->prodi == 'industri') {
            return Yii::$app->industri;
        }
        return Yii::$app->db;
    }
