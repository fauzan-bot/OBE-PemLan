...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return $this->hasMany(UserOccupationProdi::className(), ['user_id' => 'id']);
    }

    public function getOccupationki()
    {
        return $this->hasOne(Occupation::className(), ['id' => 'jabatan']);
    }
    ...
    public static function getAllProdi()
    {
        ...
        $prodi = ArrayHelper::map($prodi, 'id', 'prodi');
        return $prodi;
    }
